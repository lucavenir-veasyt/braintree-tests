defmodule BraintreeTestsWeb.Router do
  use BraintreeTestsWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {BraintreeTestsWeb.Layouts, :root}
  ...
  if Application.compile_env(:braintree_tests, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BraintreeTestsWeb.Telemetry
